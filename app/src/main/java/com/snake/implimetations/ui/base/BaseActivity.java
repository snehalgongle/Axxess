...
import com.snake.implimetations.ImpApp;
...
public abstract class BaseActivity<T extends ViewDataBinding, V extends BaseViewModel> extends AppCompatActivity
    ...
    public static void connectivityChanged(boolean b) {
        if (!b) {
            ...
            Toast.makeText(ImpApp.getInstance(), "No Internet connection!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void handleApiError(Throwable throwable) {
        if (throwable instanceof ANError) {
            ...
            Log.d(TAG, "handleApiError: "+anError.getErrorCode()+anError.getErrorDetail());
            try {
